...
export default function Tela3({ route }) {
  const {
    recheioTitulo, recheioPreco,
    coberturaTitulo, coberturaPreco,
    decoracaoTitulo, decoracaoPreco,
    formatoTitulo, formatoPreco,
    tamanhoTitulo, tamanhoPreco } = route.params;
    ...
    <View>
      <View>
        ...
        <View style={styles.containerResumo}>
          ...
          <Text style={styles.precoResumo}>R$ {coberturaPreco.toFixed(2)}</Text>
        </View>
        </View>
        ...
        <View style={styles.containerResumo}>
          ...
          <Text style={styles.precoResumo}>R$ {decoracaoPreco.toFixed(2)}</Text>
        </View>
        </View>
        ...
        <View style={styles.containerTotal}>
          <Text style={styles.total}>TOTAL: R$ {(recheioPreco + coberturaPreco + decoracaoPreco + formatoPreco + tamanhoPreco).toFixed(2)}</Text>
        </View>
